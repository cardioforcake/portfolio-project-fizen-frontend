...
function TutDetails(props){
  ...
  return(
    <div>
      ...
      Time:<Select value={props.tutParams.targetDate.getFullYear()} onChange={(e)=>updateTimeY(e.target.value, props.setTutParams)}>
              {yearOptions}
            </Select>
            <Select value={props.tutParams.targetDate.getMonth()} onChange={(e)=>updateTimeM(e.target.value, props.setTutParams)}>
              {monthOptions}
            </Select>
